  ...
  if (existingProperties === 0) {
    ...
    const vivienda = await prisma.property.create({
      data: {
        ...
        description:
          'Amplia casa de 3 dormitorios, 2 baños, cocina comedor, patio con parrilla. Zona tranquila cerca de escuelas.',
        status: 'RENTED',
        published: true,
    ...
    const localComercial = await prisma.property.create({
      data: {
        ...
        description:
          'Local comercial de 80m2 sobre avenida principal. Ideal para cualquier rubro. Baño y depósito.',
        status: 'AVAILABLE',
        published: true,
    ...
    console.log('Properties already exist, skipping property creation');
  }
}
