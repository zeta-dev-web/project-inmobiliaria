...
import { Building2, MapPin, Phone, MessageCircle, Star, Shield, ArrowLeft, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function PropertyPage({ params }: PropertyPageProps) {
  ...
  const contactWhatsApp = () => {
    ...
    window.open(`https://wa.me/5493814018196?text=${encodeURIComponent(message)}`, '_blank');
  };

  const breadcrumbItems = user?.role === "ADMIN"
    ? [{ label: "Dashboard", href: "/" }, { label: "Propiedades", href: "/properties" }, { label: property?.name || "Propiedad" }]
    : [{ label: "Propiedades", href: "/properties" }, { label: property?.name || "Propiedad" }];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                <div>
                  ...
                  <div className="aspect-video bg-gray-200 relative">
                    ...
                    {property.photos.length > 1 && (
                      <>
                        <button
                          onClick={() => setSelectedPhoto(prev => prev === 0 ? property.photos!.length - 1 : prev - 1)}
                        ...
                        <button
                          onClick={() => setSelectedPhoto(prev => prev === property.photos!.length - 1 ? 0 : prev + 1)}
            ...
            {property.type === "RENT" && (property as any).requirements && (
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-4">Requerimientos</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="mb-4">
                ...
                <h1 className="text-xl font-bold text-gray-900 mb-2 line-clamp-2">{property.name}</h1>
                      ...
                      <DropdownMenuContent align="center" className="w-48 bg-white">
                        ...
                        <DropdownMenuItem 
                          onClick={() => {
                            ...
                            window.open(`https://wa.me/5493816625078?text=${encodeURIComponent(message)}`, '_blank');
                          }}
            ...
            {/* Seller Info */}
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Inmobiliaria</h3>
              <div className="flex items-center space-x-3 mb-3">
                <img src="/favicon-32x32.png" alt="Polar Inmobiliaria" className="w-12 h-12" />
                <div>
                  <p className="font-semibold text-gray-900">Polar Inmobiliaria</p>
                  <div className="flex items-center space-x-1">
                    ...
                    <Star className="w-4 h-4 text-yellow-400 fill-current" />
                    <Star className="w-4 h-4 text-yellow-400 fill-current" />
                    <span className="text-sm text-gray-500 ml-1">Inmobiliaria</span>
                  </div>
                </div>
              </div>
            ...
            {/* Trust Badges */}
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Garantías</h3>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <Shield className="w-5 h-5 text-green-500" />
                  <span className="text-sm text-gray-700">Inmobiliaria verificada</span>
                </div>
                <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-gray-700">Propiedades garantizadas</span>
                </div>
              </div>
            </div>
          </div>
